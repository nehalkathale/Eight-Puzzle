package edu.uncc.intelligentsystems;

import java.util.ArrayList;
import java.util.Scanner;

//Logic of 8 Puzzle problem solving with A* algorithm is coded in this class
public class AStarAlgorithmHeuristic {
	...
	//This function gets the initial and expected goal state from users and calls all functions handling algorithm logic 
	...
	//This function checks for duplicate state if any generated before, then its return true 'foundNode' variable to avoid infinite execution
	...
	//This function prints the path of solution from initial node to goal node 
